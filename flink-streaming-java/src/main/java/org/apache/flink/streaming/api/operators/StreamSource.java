...
public class StreamSource<OUT, SRC extends SourceFunction<OUT>> extends AbstractUdfStreamOperator<OUT, SRC> {
	...
	public void run(final Object lockingObject,
        ...
        this.ctx = StreamSourceContexts.getSourceContext(
                ...
                watermarkInterval,
                -1,
                this.getContainingTask().getSchedulerMonitor());
				...
				new ProcessingTimeCallback() {
					...
					public void onProcessingTime(long timestamp) throws Exception {
						try {
							...
							output.emitLatencyMarker(new LatencyMarker(processingTimeService.getCurrentProcessingTime(), operatorId, subtaskIndex, true));
						} catch (Throwable t) {
