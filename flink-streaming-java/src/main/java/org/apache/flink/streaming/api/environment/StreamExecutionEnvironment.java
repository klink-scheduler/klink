...
public abstract class StreamExecutionEnvironment {
	...
	/** The scheduling policy used. Default is no scheduler. */
	private StreamTaskSchedulerPolicy streamTaskSchedulerPolicy = StreamTaskSchedulerPolicy.OS_SCHEDULER;
	// --------------------------------------------------------------------------------------------
	...
	*/
	...
	/**
	 * Gets the scheduling policy set by the user.
	 *
	 * @return The scheduling policy used to schedule executing threads.
	 */
	public StreamTaskSchedulerPolicy getStreamTaskSchedulerPolicy() {
		return this.streamTaskSchedulerPolicy;
	}

	/**
	 * Sets the scheduling policy at the environment level.
	 *
	 * @param streamTaskSchedulerPolicy The scheduling policy used to schedule executing threads.
	 */
	public void setStreamTaskSchedulerPolicy(StreamTaskSchedulerPolicy streamTaskSchedulerPolicy) {
		this.streamTaskSchedulerPolicy = streamTaskSchedulerPolicy;
	}
