...
public abstract class StreamTask<OUT, OP extends StreamOperator<OUT>>
	...
	/** SchedulerMonitor to determine the execution */
	protected SchedulerMonitor schedulerMonitor;
	// ------------------------------------------------------------------------
	...
	public final void setSchedulerMonitor(SchedulerMonitor schedulerMonitor) {
		this.schedulerMonitor = schedulerMonitor;
	}

	public SchedulerMonitor getSchedulerMonitor() {
		return this.schedulerMonitor;
	}

	public StreamOperator getLastOperator () {
		StreamOperator[] operators = operatorChain.getAllOperators();
	...
	public OperatorChain<OUT, OP> getOperatorChain() {
		return operatorChain;
	}
