...
import org.apache.flink.streaming.runtime.tasks.scheduler.StreamTaskScheduler;
...
public class StreamingJobGraphGenerator {
	...
	private JobGraph createJobGraph() {
		...
		// Set the TaskScheduler metadata information in the JobGraph
		jobGraph.setTaskSchedulerClassName(StreamTaskScheduler.class.getName());
		jobGraph.setTaskSchedulerPolicy(streamGraph.getEnvironment().getStreamTaskSchedulerPolicy().getSchedulerName());
