...
public class TimestampsAndPunctuatedWatermarksOperator<T>
	...
	public void processElement(StreamRecord<T> element) throws Exception {
		...
		if (nextWatermark != null && nextWatermark.getTimestamp() > currentWatermark) {
			...
			// Create a new blocking latency marker
//			LatencyMarker blockingLatencyMarker = new LatencyMarker(
//					getProcessingTimeService().getCurrentProcessingTime(),
//					getOperatorID(),
//					getRuntimeContext().getIndexOfThisSubtask(), true);
//			output.emitLatencyMarker(blockingLatencyMarker);
		}
	}
