...
public class LatencyStatsTest extends TestLogger {
	...
	private static void testLatencyStats(
		...
		latencyStats.reportLatency(new LatencyMarker(0L, SOURCE_ID_1, 0, false));
		latencyStats.reportLatency(new LatencyMarker(0L, SOURCE_ID_1, 0, false));
		latencyStats.reportLatency(new LatencyMarker(0L, SOURCE_ID_1, 1, false));
		latencyStats.reportLatency(new LatencyMarker(0L, SOURCE_ID_2, 2, false));
		latencyStats.reportLatency(new LatencyMarker(0L, SOURCE_ID_2, 3, false));
