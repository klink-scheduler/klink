...
public class JobGraph implements Serializable {
	...
	/** The class of the TaskScheduler */
	private String taskSchedulerClassName;

	/** The policy of the TaskScheduler */
	...
	/* Methods to propagate scheduler information */
	public String getTaskSchedulerClassName() {
		return taskSchedulerClassName;
	}

	public void setTaskSchedulerClassName(String taskSchedulerClassName) {
		this.taskSchedulerClassName = taskSchedulerClassName;
	}

	public String getTaskSchedulerPolicy() {
		return taskSchedulerPolicy;
	}

	public void setTaskSchedulerPolicy(String taskSchedulerPolicy) {
