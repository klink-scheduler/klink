...
public class ExecutionGraphBuilder {
	...
	public static ExecutionGraph buildGraph(
		...
		/*
		 * TaskScheduler specific API-level metadata.
		 * Constructor was not changed to preserve compatibility.
		 */
		jobInformation.setTaskSchedulerClassName(jobGraph.getTaskSchedulerClassName());
		jobInformation.setTaskSchedulerPolicy(jobGraph.getTaskSchedulerPolicy());
