...
public class MetricNames {
	...
	public static final String IO_NUM_WATERMARKS_IN = "numWatermarksIn";
	public static final String IO_NUM_WATERMARKS_OUT = "numWatermarksOut";

	public static final String IO_NUM_LATENCY_MARKERS_IN = "numLatencyMarkersIn";
	public static final String IO_NUM_LATENCY_MARKERS_OUT = "numLatencyMarkersOut";
	...
	public static final String IO_TOTAL_PROCESSING_TIME = "totalProcessingTime";
