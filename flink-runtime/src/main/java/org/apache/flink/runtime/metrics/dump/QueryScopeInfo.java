...
public abstract class QueryScopeInfo {
	...
	public static final byte INFO_CATEGORY_TS = 5;
    ...
    /**
     * Container for the scheduler scope. Stores the name of the scheduler.
     */
    public static class TaskSchedulerQueryScopeInfo extends QueryScopeInfo {
        public final String schedulerName;
        public final String taskManagerID;

        public TaskSchedulerQueryScopeInfo(String taskManagerID, String schedulerName) {
            this(taskManagerID, schedulerName, "");
        }

        public TaskSchedulerQueryScopeInfo(String taskManagerID, String schedulerName, String scope) {
            super(scope);
            this.taskManagerID = taskManagerID;
        ...
        @Override
        public TaskSchedulerQueryScopeInfo copy(String additionalScope) {
            return new TaskSchedulerQueryScopeInfo(this.taskManagerID, this.schedulerName, concatScopes(additionalScope));
        }

        @Override
        public byte getCategory() {
            return INFO_CATEGORY_TS;
        }
    }
