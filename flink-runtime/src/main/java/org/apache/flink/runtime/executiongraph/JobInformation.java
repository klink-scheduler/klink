...
public class JobInformation implements Serializable {
	...
	/** Classname of the TaskScheduler */
	private String taskSchedulerClassName;

	/** Policy of the TaskScheduler*/
	...
	public String getTaskSchedulerPolicy() { return taskSchedulerPolicy; }

	void setTaskSchedulerClassName(String taskSchedulerClassName) {
		this.taskSchedulerClassName = taskSchedulerClassName;
	}

	void setTaskSchedulerPolicy(String taskSchedulerPolicy) {
